namespace Bot.BackgroundServices
{
    ...
    public class JobManager : IDisposable
    {
        ...
        private readonly BotLog bloonLog;
        private readonly IServiceProvider services;
        private Timer timer;

        public JobManager(BotContextFactory dbFactory, ActivityManager activityManager, BotLog bloonLog, IServiceProvider services)
        {
        ...
        private async void TimerElapsed(object sender, ElapsedEventArgs e)
        {
            ...
            using (BotContext db = this.dbFactory.Create())
            {
